...
#ifndef FAKEIMAGECOLLECTIONSHARED_H
#define FAKEIMAGECOLLECTIONSHARED_H

#include <kurl.h>
#include <libkipi/imagecollectionshared.h>

class FakeImageCollectionShared : public KIPI::ImageCollectionShared
{
...
#endif // FAKEIMAGECOLLECTIONSHARED_H
